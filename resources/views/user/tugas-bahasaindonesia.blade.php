...
@section('title', 'Tugas Bahasa Indonesia')

@section('content')

    <div class="text-center">
        <h2 class="mb-3">Tugas Bahasa Indonesia</h2>
    </div>
        ...
        @if (Auth::user()->role_id == 3)
            <div class="col">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <form action="/add-tugas-bahasaindonesia" method="POST" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="single-select-field1" name="nisn"
                                            ...
                                            @foreach ($siswa as $data)
                                                <option value="{{ $data->nisn }}">{{ $data->nisn }} -
                                                    {{ $data->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered text-center">
            ...
            @foreach ($tugasbahasaindonesia->reverse() as $data)
                <tbody>
                    <tr>
                        ...
                        @if (Auth::User()->role_id == 2)
                            <td>
                                ...
                                <form action="/delete-tugas-bahasaindonesia/{{ $data->id }}" method="POST"
    ...
    <div>
        {{ $tugasbahasaindonesia->withQueryString()->links() }}
    </div>
