...
@section('title', 'Tugas IPA')

@section('content')

    <div class="text-center">
        <h2 class="mb-3">Tugas Ilmu Pengetahuan Alam</h2>
    </div>
        ...
        @if (Auth::user()->role_id == 3)
            <div class="col">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <form action="/add-tugas-ipa" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <tr>
                        ...
                        @if (Auth::User()->role_id == 2)
                            <td>
                                ...
                                <form action="/delete-tugas-ipa/{{ $data->id }}" method="POST"
