...
@section('title', 'Materi PABP')

@section('content')

    <div class="text-center">
        <h2 class="mb-3">Materi Pendidikan Agama dan Budi Pekerti</h2>
    </div>
    ...
    <div class="row">
        @if (Auth::user()->role_id == 2)
            <div class="col">
                ...
                <a href="/tugas-pabp" class="btn btn-success mb-3">Tugas</a>

                <!-- Modal -->
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <form action="/add-materi-pabp" method="POST" enctype="multipart/form-data">
                        @csrf
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            @if (Auth::User()->role_id == 2)
                                <form action="/delete-materi-pabp/{{ $data->id }}" method="POST"
