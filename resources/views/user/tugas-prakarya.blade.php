...
@section('title', 'Tugas Prakarya')

@section('content')

    <div class="text-center">
        <h2 class="mb-3">Tugas Prakarya</h2>
    </div>
        ...
        @if (Auth::user()->role_id == 3)
            <div class="col">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <form action="/add-tugas-prakarya" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="table-responsive">
        <table class="table table-bordered text-center">
            ...
            @foreach ($tugasprakarya->reverse() as $data)
                <tbody>
                    <tr>
                        ...
                        @if (Auth::User()->role_id == 2)
                            <td>
                                ...
                                <form action="/delete-tugas-prakarya/{{ $data->id }}" method="POST"
    ...
    <div>
        {{ $tugasprakarya->withQueryString()->links() }}
    </div>
