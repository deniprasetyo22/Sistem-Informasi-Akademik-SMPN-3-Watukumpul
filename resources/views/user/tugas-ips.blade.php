...
@section('title', 'Tugas IPS')

@section('content')

    <div class="text-center">
        <h2 class="mb-3">Tugas Ilmu Pengetahuan Sosial</h2>
    </div>
        ...
        @if (Auth::user()->role_id == 3)
            <div class="col">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <form action="/add-tugas-ips" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <tr>
                        ...
                        @if (Auth::User()->role_id == 2)
                            <td>
                                ...
                                <form action="/delete-tugas-ips/{{ $data->id }}" method="POST"
