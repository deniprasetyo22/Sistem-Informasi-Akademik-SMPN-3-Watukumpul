...
@section('Page Title', 'Tugas Pendidikan Jasmani, Olahraga, dan Kesehatan')

@section('link', '/admin-materi')

@section('back', 'Materi')

@section('link2', '/admin-materi-pjok')

@section('back2', 'Materi Pendidikan Jasmani, Olahraga, dan Kesehatan')
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="/admin-delete-tugas-pjok/{{ $data->id }}" method="POST"
