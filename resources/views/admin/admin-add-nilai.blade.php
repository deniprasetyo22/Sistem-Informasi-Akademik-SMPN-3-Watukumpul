...
@section('content')
    ...
    <div class="mt-5 col-8 m-auto">
        <form action="/admin-nilai" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="jenis_kelamin" id="select" required>
                ...
                <div class="row">
                    <div class="col-4">
                        <input type="number" step="any" class="form-control" name="seni_budaya_a"
                            id="seni_budaya_a" placeholder="Niai Pengetahuan">
                    </div>
                    <div class="col-4">
                        <input type="number" step="any" class="form-control" name="seni_budaya_b"
                            id="seni_budaya_b" placeholder="Nilai Keterampilan">
                    </div>
                    <div class="col-4">
